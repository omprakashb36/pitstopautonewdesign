...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`${theme === "dark" ? 'dark:text-black dark:bg-black border border-solid border-white' : 'text-black bg-gray-200'} p-2 themeButton absolute ltr:right-[245px] rtl:left-[255px] top-[54px] z-[49] rounded-xl transition`}
    >
